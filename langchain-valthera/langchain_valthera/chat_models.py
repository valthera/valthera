...
class ChatValthera(BaseChatModel):
    ...
    """Valthera chat model integration.

    The default implementation echoes the first `parrot_buffer_length` characters of the input.

    # TODO: Replace with relevant packages, env vars.
    Setup:
        Install ``langchain-valthera`` and set environment variable ``VALTHERA_API_KEY``.

        .. code-block:: bash

            pip install -U langchain-valthera
            export VALTHERA_API_KEY="your-api-key"

    # TODO: Populate with relevant params.
    Key init args — completion params:
        model: str
            Name of Valthera model to use.
        temperature: float
    ...
    Key init args — client params:
        ...
        api_key: Optional[str]
            Valthera API key. If not passed in will be read from env var VALTHERA_API_KEY.
    ...
    Tool calling:
        ...
        See ``ChatValthera.bind_tools()`` method for more.
    ...
    Structured output:
        ...
        See ``ChatValthera.with_structured_output()`` for more.
    ...
    # TODO: Implement if ChatValthera supports async streaming. Otherwise delete.
    # async def _astream(
    #     self,
    #     messages: List[BaseMessage],
    #     stop: Optional[List[str]] = None,
    ...
    # TODO: Implement if ChatValthera supports async generation. Otherwise delete.
